      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="md:col-span-1 space-y-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed font-light">
              Advancing Islamic scholarship through context-aware AI translation
              tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 md:col-span-3 gap-12 text-left">
            <div className="space-y-4">
              <h4 className="font-heading text-sm font-bold uppercase tracking-widest text-primary">
                Product
              </h4>
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            <Link
              href="/privacy"
              className="text-xs text-muted-foreground hover:text-primary font-light"
            >
              Privacy Policy
            </Link>
            <Link
