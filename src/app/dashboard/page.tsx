    ...
    <DashboardShell convexAvailable={false}>
      ...
      <div className="rounded-2xl border border-dashed border-border bg-card/60 px-6 py-16 text-center">
        ...
        <h2 className="font-heading text-lg font-semibold">
          Projects Require Convex
        </h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This dashboard switches to live Convex queries when the deployment URL
          is available.
        </p>
      </div>
    </DashboardShell>
      ...
      {showNewProject && (
        <Card className="mb-6 border-primary/15">
          <CardHeader>
            ...
            <CardDescription>
              Start a new Arabic-to-English translation workflow.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      setForm((current) => ({
                        ...current,
                        genre: event.target.value as NonNullable<
                          Project["genre"]
                        >,
                      }))
                    }
